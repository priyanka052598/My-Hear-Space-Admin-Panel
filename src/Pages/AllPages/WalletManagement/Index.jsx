          ...
          <div>
            {/* inputs */}
              ...
              <div className="search w-1/2 border-[1px] border-[#808080] flex justify-start items-center bg-white rounded-3xl ">
                ...
                <input className='w-full mr-3 py-2 rounded-3xl bg-white outline-none' placeholder='Search by Phone Number' type="text" />
...
<td className="p-3 flex justify-start items-center gap-1">{item.phone} </td>
                      <td className="p-3">{item.walletbalance} </td>
                      <td className="p-3">{item.totalcredited} </td>
                      <td className="p  w-fit"> <Link to="/User&WalletDetails/WalletDetails">
                        <div
