...
function AddNewBlog() {
  ...
  return (
    <div>  <div className='flex overflow-y-auto h-screen bg-[#F0F0F0]'>
    <Sidebar />
...
<button className='text-[18px] text-black mr-7 px-6 py-2 border-[1px] border-black rounded-[8px]' type="button"> Discard   </button>
<button onClick={()=>{
  setShowPopup(true)
}} className='text-[18px] text-white mr-7 px-6 py-2 bg-[#3A3A3A] rounded-[8px]' type="button">Upload Blog  </button>
