...
function EditBlog() {
  ...
  return (
    <div>  <div>  <div className='flex overflow-y-auto h-screen bg-[#F0F0F0]'>
    <Sidebar />
        ...
        <div className=''>
          ...
          <div className="headings px-7 pt-7 flex flex-col justify-start ">
                                   ...
                                   <div className='flex gap-2 my-2'>
                                       ...
                                       <Link to="/BlogManagement"  className='dashboard cursor-pointer flex justify-start items-center gap-1'>
                                           <div className="text-[#808080]">Blog Management</div> <IoIosArrowForward className='text-[#808080]' />
                                       </Link>
                                       <div className="listener text-[16px]">Edit Blog</div>
                               </div>
                           </div>
      ...
      <div className=' rounded-[24px] bg-white px-[40px] py-[30px]'>
        ...
        <div className='flex flex-col gap-[24px]'>
          ...
          <div className="Blog Title">
            ...
            <div className='w-full border-[1px] border-[#808080] py-2 px-3 rounded-[12px]'> <input placeholder=' Enter Title' className='w-full outline-none bg-transparent' type="text" name="" id="" /></div>
          </div>
          <div className="Tag for the Blog">
            <h3 className='text-[18px] my-1'>Tag for the Blog </h3>
            <div className='w-full border-[1px] border-[#808080] py-2 px-3 rounded-[12px]'> <input placeholder='Enter Tag' className='w-full outline-none bg-transparent' type="text" name="" id="" /></div>
          </div>
...
<button className='text-[18px] text-black mr-7 px-6 py-2 border-[1px] border-black rounded-[8px]' type="button"> Delete    </button>
<button onClick={()=>{
  setShowPopup(true)
}} className='text-[18px] text-white mr-7 px-6 py-2 bg-[#3A3A3A] rounded-[8px]' type="button">Edit Blog  </button>
                   { showPopup && <SucessfullPopup  text={"Upload Successfully!"} setShowPopup={setShowPopup}/> } 
