...
<div className=' w-[60%]  bg-white rounded-[24px] px-[40px] py-[30px] flex flex-col'>
    ...
    <div className=''>
      <div className='flex  flex-col gap-[12px]'>
        {RatingData.map((item)=>{
        return  <div className='bg-[#f0f0f0] p-[16px] rounded-[12px]  flex flex-col gap-[12px]'>
            <div className='flex justify-between items-center'>
            <div className='flex gap-1'>  {Array.from({ length: item.ratingCount }).map((_, i) => (
              <GoStarFill key={i} />
            ))}</div>  
              <span>{item.date}</span>
            </div>
...
<div className=" flex">
    <div className="left w-1/2 flex gap-2 flex-col justify-center items-center">
        <div><PiMedalFill className='text-[55px]'/> </div>
        <span className='text-[18px] '>1208 Hrs</span>
    </div>
    <div className="right w-1/2 flex flex-col gap-[5px]">
        <div className="1 flex justify-center items-center  gap-[12px]">
          
            <div className='w-full gap-[12px] flex  justify-center items-center h-full'><FiMessageCircle className='text-[32px]' /> <Progressbar progress={10}/> <span>10%</span>
            </div>
        </div>
        ...
        <div className="1 flex justify-center items-center  gap-[12px]">
            ...
            <div className='w-full gap-[12px] flex  justify-center items-center h-full'><FiPhoneCall className='text-[32px]' /> <Progressbar progress={20}/> <span>0%</span>
            </div>
        </div>
        <div className="1 flex justify-center items-center  gap-[12px]">
           
            <div className='w-full gap-[12px] flex  justify-center items-center h-full'><FiVideo className='text-[32px]' /> <Progressbar progress={50}/> <span>50%</span>
            </div>
        </div>
    </div>
</div>
